...
export function createSupplementalCatalogue() {
  ...
  add("3 o más miembros inscritos: 5 € de descuento mensual por persona. Si entrenan 1 día/semana: 2,50 € por persona.", "3 membres inscrits o més: 5 € de descompte mensual per persona. Si entrenen 1 dia/setmana: 2,50 € per persona.", "3 ou máis membros inscritos: 5 € de desconto mensual por persoa. Se adestran 1 día/semana: 2,50 € por persoa.", "Izena emanda duten 3 kide edo gehiago: hilean 5 €-ko deskontua pertsonako. Astean egun 1 entrenatzen badute: 2,50 € pertsonako.");
  add("Las familias con tres o más miembros inscritos disfrutarán de un descuento en las cuotas mensuales de 5 € por persona. En las inscripciones de un solo día de entrenamiento a la semana, el descuento será de 2,50 € por persona.", "Les famílies amb tres membres inscrits o més gaudiran d'un descompte en les quotes mensuals de 5 € per persona. En les inscripcions d'un sol dia d'entrenament a la setmana, el descompte serà de 2,50 € per persona.", "As familias con tres ou máis membros inscritos gozarán dun desconto nas cotas mensuais de 5 € por persoa. Nas inscricións dun só día de adestramento á semana, o desconto será de 2,50 € por persoa.", "Izena emanda duten hiru kide edo gehiagoko familiek hileko kuotetan 5 €-ko deskontua izango dute pertsonako. Astean entrenamendu egun bakarreko izen-emateetan, deskontua 2,50 € izango da pertsonako.");
  ...
  add("Se abona en un único pago al inicio de temporada. En escolares incluye camiseta Lô Esport de regalo; desde Sub-20 solo la pagan las nuevas incorporaciones.", "S'abona en un únic pagament a l'inici de temporada. En escolars inclou samarreta Lô Esport de regal; des de Sub-20 només la paguen les noves incorporacions.", "Abóase nun único pagamento ao inicio da tempada. En escolares inclúe camiseta Lô Esport de agasallo; desde Sub-20 só a pagan as novas incorporacións.", "Denboraldi hasieran ordainketa bakarrean ordaintzen da. Eskola-kategorietan Lô Esport kamiseta opari dakar; Sub-20tik aurrera kide berriek bakarrik ordaintzen dute.");
  add("Se abona en un único pago al inicio de temporada. En escolares incluye camiseta Lô Esport de regalo y acceso a las instalaciones en horario reservado.", "S'abona en un únic pagament a l'inici de temporada. En escolars inclou samarreta Lô Esport de regal i accés a les instal·lacions en horari reservat.", "Abóase nun único pagamento ao inicio da tempada. En escolares inclúe camiseta Lô Esport de agasallo e acceso ás instalacións en horario reservado.", "Denboraldi hasieran ordainketa bakarrean ordaintzen da. Eskola-kategorietan Lô Esport kamiseta opari eta instalazioetarako sarbidea dakar erreserbatutako ordutegian.");
  add("Qué incluye la matrícula", "Què inclou la matrícula", "Que inclúe a matrícula", "Matrikulak zer barne hartzen duen");
  add("Categorías escolares, hasta Sub-18 incluido", "Categories escolars, fins a Sub-18 inclòs", "Categorías escolares, ata Sub-18 incluído", "Eskola-kategoriak, Sub-18 barne");
  add("La matrícula se abonará en un único pago al inicio de la temporada. Incluye los gastos de gestión, el material deportivo y el acceso a las instalaciones durante los horarios reservados por el club. Camiseta Lô Esport de regalo.", "La matrícula s'abonarà en un únic pagament a l'inici de la temporada. Inclou les despeses de gestió, el material esportiu i l'accés a les instal·lacions durant els horaris reservats pel club. Samarreta Lô Esport de regal.", "A matrícula abonarase nun único pagamento ao inicio da tempada. Inclúe os gastos de xestión, o material deportivo e o acceso ás instalacións durante os horarios reservados polo club. Camiseta Lô Esport de agasallo.", "Matrikula denboraldi hasieran ordainketa bakarrean ordainduko da. Kudeaketa gastuak, kirol materiala eta klubak erreserbatutako ordutegietan instalazioetarako sarbidea barne hartzen ditu. Lô Esport kamiseta opari.");
  add("Categorías Sub-20 en adelante", "Categories Sub-20 en endavant", "Categorías Sub-20 en diante", "Sub-20 kategoriatik aurrera");
  add("La matrícula de inscripción se abonará en un único pago al inicio de la temporada. A partir de la categoría Sub-20, solo deberán abonarla las nuevas incorporaciones. Los deportistas que ya estuvieron inscritos en el club durante la temporada 2025-2026 estarán exentos de este pago; las inscripciones anteriores a 2025 se entenderán como nuevas incorporaciones.", "La matrícula d'inscripció s'abonarà en un únic pagament a l'inici de la temporada. A partir de la categoria Sub-20, només l'hauran d'abonar les noves incorporacions. Els esportistes que ja van estar inscrits al club durant la temporada 2025-2026 estaran exempts d'aquest pagament; les inscripcions anteriors a 2025 s'entendran com a noves incorporacions.", "A matrícula de inscrición abonarase nun único pagamento ao inicio da tempada. A partir da categoría Sub-20, só deberán abonala as novas incorporacións. Os deportistas que xa estiveron inscritos no club durante a tempada 2025-2026 estarán exentos deste pagamento; as inscricións anteriores a 2025 entenderanse como novas incorporacións.", "Izen-emateko matrikula denboraldi hasieran ordainketa bakarrean ordainduko da. Sub-20 kategoriatik aurrera, kide berriek bakarrik ordaindu beharko dute. 2025-2026 denboraldian klubean izena emanda egon ziren kirolariek ez dute ordainketa hori egin beharko; 2025a baino lehenagoko izen-emateak kide berritzat hartuko dira.");
  add("Matrícula de inscripción", "Matrícula d'inscripció", "Matrícula de inscrición", "Izen-emateko matrikula");
  add("Se abona en un único pago al inicio de temporada. Hasta Sub-18 incluye gestión, material, acceso a instalaciones y camiseta Lô Esport. Desde Sub-20 solo la pagan las nuevas incorporaciones; quienes ya estuvieron inscritos en 2025-2026 están exentos.", "S'abona en un únic pagament a l'inici de temporada. Fins a Sub-18 inclou gestió, material, accés a instal·lacions i samarreta Lô Esport. Des de Sub-20 només la paguen les noves incorporacions; qui ja va estar inscrit el 2025-2026 n'està exempt.", "Abóase nun único pagamento ao inicio da tempada. Ata Sub-18 inclúe xestión, material, acceso a instalacións e camiseta Lô Esport. Desde Sub-20 só a pagan as novas incorporacións; quen xa estivo inscrito en 2025-2026 está exento.", "Denboraldi hasieran ordainketa bakarrean ordaintzen da. Sub-18ra arte kudeaketa, materiala, instalazioetarako sarbidea eta Lô Esport kamiseta barne hartzen ditu. Sub-20tik aurrera kide berriek bakarrik ordaintzen dute; 2025-2026an izena emanda egon zirenek salbuespena dute.");
  ...
  add("Datos comunes de la familia", "Dades comunes de la família", "Datos comúns da familia", "Familiaren datu komunak");
  add("Se aplicarán a todas las personas de esta inscripción.", "S'aplicaran a totes les persones d'aquesta inscripció.", "Aplicaranse a todas as persoas desta inscrición.", "Izen-emate honetako pertsona guztiei aplikatuko zaizkie.");
  add("Hijos, hijas, madres y padres de las escuelas de Alaior y Maó pueden compartir los datos comunes. Las familias con tres o más miembros inscritos disfrutarán de un descuento en las cuotas mensuales de 5 € por persona. En las inscripciones de un solo día de entrenamiento a la semana, el descuento será de 2,50 € por persona.", "Fills, filles, mares i pares de les escoles d'Alaior i Maó poden compartir les dades comunes. Les famílies amb tres membres inscrits o més gaudiran d'un descompte en les quotes mensuals de 5 € per persona. En les inscripcions d'un sol dia d'entrenament a la setmana, el descompte serà de 2,50 € per persona.", "Fillos, fillas, nais e pais das escolas de Alaior e Maó poden compartir os datos comúns. As familias con tres ou máis membros inscritos gozarán dun desconto nas cotas mensuais de 5 € por persoa. Nas inscricións dun só día de adestramento á semana, o desconto será de 2,50 € por persoa.", "Alaior eta Maóko eskoletako seme-alabek, amek eta aitek datu komunak parteka ditzakete. Izena emanda duten hiru kide edo gehiagoko familiek hileko kuotetan 5 €-ko deskontua izango dute pertsonako. Astean entrenamendu egun bakarreko izen-emateetan, deskontua 2,50 € izango da pertsonako.");
  add("Madre, padre o tutor legal", "Mare, pare o tutor legal", "Nai, pai ou titor legal", "Ama, aita edo legezko tutorea");
  add("Estos datos se guardarán únicamente en las filas de los hijos e hijas.", "Aquestes dades es desaran únicament a les files dels fills i filles.", "Estes datos gardaranse unicamente nas filas dos fillos e fillas.", "Datu hauek seme-alaben errenkadetan bakarrik gordeko dira.");
  add("Un único pago para la familia", "Un únic pagament per a la família", "Un único pagamento para a familia", "Ordainketa bakarra familiarentzat");
  add("La opción elegida se reflejará en cada fila para facilitar la gestión.", "L'opció triada es reflectirà a cada fila per facilitar la gestió.", "A opción elixida reflectirase en cada fila para facilitar a xestión.", "Aukeratutako aukera errenkada bakoitzean agertuko da kudeaketa errazteko.");
  add("La persona responsable acepta en nombre de esta inscripción familiar.", "La persona responsable accepta en nom d'aquesta inscripció familiar.", "A persoa responsable acepta en nome desta inscrición familiar.", "Arduradunak familia-izen-emate honen izenean onartzen du.");
  add("Elige su grupo escolar y los días concretos.", "Tria el seu grup escolar i els dies concrets.", "Elixe o seu grupo escolar e os días concretos.", "Hautatu eskola-taldea eta egun zehatzak.");
  add("El grupo de madres y padres coincide con el horario de la escuela.", "El grup de mares i pares coincideix amb l'horari de l'escola.", "O grupo de nais e pais coincide co horario da escola.", "Gurasoen taldeak eskolaren ordutegi bera du.");
  add("Documentación y datos propios de esta persona.", "Documentació i dades pròpies d'aquesta persona.", "Documentación e datos propios desta persoa.", "Pertsona honen dokumentazioa eta datuak.");
  add("Salud y autorizaciones", "Salut i autoritzacions", "Saúde e autorizacións", "Osasuna eta baimenak");
  add("Paso 1 de 2", "Pas 1 de 2", "Paso 1 de 2", "1. urratsa, 2tik");
  add("¿Quién se inscribe?", "Qui s'inscriu?", "Quen se inscribe?", "Nor emango du izena?");
  add("Indica la sede y cuántas personas van a entrenar. La persona adulta que solo actúa como tutor no se cuenta.", "Indica la seu i quantes persones entrenaran. La persona adulta que només actua com a tutor no es compta.", "Indica a sede e cantas persoas van adestrar. A persoa adulta que só actúa como titora non se conta.", "Adierazi egoitza eta zenbat pertsonak entrenatuko duten. Tutore gisa soilik aritzen den heldua ez da zenbatzen.");
  add("Sede de la escuela", "Seu de l'escola", "Sede da escola", "Eskolaren egoitza");
  add("Cada participante acabará en una fila independiente de la hoja de inscripciones.", "Cada participant quedarà en una fila independent del full d'inscripcions.", "Cada participante quedará nunha fila independente da folla de inscricións.", "Parte-hartzaile bakoitza izen-emate orriko errenkada independente batean geratuko da.");
  add("Preparar inscripción familiar →", "Preparar inscripció familiar →", "Preparar inscrición familiar →", "Prestatu familia-izen-ematea →");
  add("Hijo/a", "Fill/a", "Fillo/a", "Seme-alaba");
  add("Madre/padre", "Mare/pare", "Nai/pai", "Ama/aita");
  add("Elige su grupo y completa solo sus datos personales.", "Tria el seu grup i completa només les seves dades personals.", "Elixe o seu grupo e completa só os seus datos persoais.", "Hautatu taldea eta bete bere datu pertsonalak bakarrik.");
  add("Se aplicará la tarifa especial por entrenar mientras está la escuela.", "S'aplicarà la tarifa especial per entrenar mentre hi ha escola.", "Aplicarase a tarifa especial por adestrar mentres está a escola.", "Eskola martxan dagoen bitartean entrenatzeagatik tarifa berezia aplikatuko da.");
  add("Paso 2 de 2", "Pas 2 de 2", "Paso 2 de 2", "2. urratsa, 2tik");
  add("Cambiar composición", "Canviar composició", "Cambiar composición", "Aldatu osaera");
  add("Se perderán los datos que hayas escrito. ¿Quieres volver a empezar?", "Es perdran les dades que hagis escrit. Vols tornar a començar?", "Perderanse os datos que escribiches. Queres volver empezar?", "Idatzitako datuak galduko dira. Berriro hasi nahi duzu?");
  add("Una sola vez", "Una sola vegada", "Unha soa vez", "Behin bakarrik");
  add("Datos comunes", "Dades comunes", "Datos comúns", "Datu komunak");
  add("Domicilio, tutor legal, pago y consentimientos para toda la familia.", "Domicili, tutor legal, pagament i consentiments per a tota la família.", "Enderezo, titor legal, pagamento e consentimentos para toda a familia.", "Helbidea, legezko tutorea, ordainketa eta familia osoaren baimenak.");
  add("Una ficha por persona", "Una fitxa per persona", "Unha ficha por persoa", "Fitxa bat pertsonako");
  add("Participantes", "Participants", "Participantes", "Parte-hartzaileak");
  add("Cada ficha generará su propia fila en la hoja de inscripciones.", "Cada fitxa generarà la seva pròpia fila al full d'inscripcions.", "Cada ficha xerará a súa propia fila na folla de inscricións.", "Fitxa bakoitzak bere errenkada sortuko du izen-emate orrian.");
  add("Se guardará una fila por persona con una misma referencia familiar.", "Es desarà una fila per persona amb una mateixa referència familiar.", "Gardarase unha fila por persoa coa mesma referencia familiar.", "Pertsona bakoitzeko errenkada bat gordeko da familia-erreferentzia berarekin.");
  add("Enviar familia", "Enviar família", "Enviar familia", "Bidali familia");
  add("Familia inscrita", "Família inscrita", "Familia inscrita", "Familia izena emanda");
  add("Todo listo.", "Tot a punt.", "Todo listo.", "Dena prest.");
  add("Continuar envío", "Continuar l'enviament", "Continuar o envío", "Jarraitu bidalketa");
  add("Reintentar", "Tornar-ho a provar", "Tentar de novo", "Saiatu berriro");
  add("Entrenamiento simultáneo", "Entrenament simultani", "Adestramento simultáneo", "Aldi bereko entrenamendua");
  add("¿Y si entrenáis también las madres y los padres?", "I si també entrenau les mares i els pares?", "E se tamén adestrades as nais e os pais?", "Eta amek eta aitek ere entrenatuko bazenute?");
  add("Inscribir a toda la familia", "Inscriure tota la família", "Inscribir toda a familia", "Eman izena familia osoari");
  add("Inscripción familiar", "Inscripció familiar", "Inscrición familiar", "Familia-izen-ematea");
  add("Solo aparecen los grupos compatibles con esta inscripción familiar.", "Només apareixen els grups compatibles amb aquesta inscripció familiar.", "Só aparecen os grupos compatibles con esta inscrición familiar.", "Familia-izen-emate honekin bateragarriak diren taldeak bakarrik agertzen dira.");
  add("Tarifa para madres y padres con un hijo o hija en la escuela", "Tarifa per a mares i pares amb un fill o filla a l'escola", "Tarifa para nais e pais cun fillo ou filla na escola", "Eskolan seme-alaba duten ama eta aiten tarifa");
  add("Inscripción familiar — Lô Esport Menorca", "Inscripció familiar — Lô Esport Menorca", "Inscrición familiar — Lô Esport Menorca", "Familia-izen-ematea — Lô Esport Menorca");
  add("Inscripción familiar de Lô Esport Menorca para hijos, hijas, madres y padres de las escuelas de Alaior y Maó.", "Inscripció familiar de Lô Esport Menorca per a fills, filles, mares i pares de les escoles d'Alaior i Maó.", "Inscrición familiar de Lô Esport Menorca para fillos, fillas, nais e pais das escolas de Alaior e Maó.", "Lô Esport Menorcaren familia-izen-ematea, Alaior eta Maóko eskoletako seme-alaba eta gurasoentzat.");
  add("Inscripción conjunta para familias", "Inscripció conjunta per a famílies", "Inscrición conxunta para familias", "Familientzako izen-emate bateratua");
  add("individual ↗", "individual ↗", "individual ↗", "banakakoa ↗");
  add("FAMILIAS · 2026", "FAMÍLIES · 2026", "FAMILIAS · 2026", "FAMILIAK · 2026");
  add("Inscripción familiar 2026", "Inscripció familiar 2026", "Inscrición familiar 2026", "2026ko familia-izen-ematea");
  add("Inscripción individual", "Inscripció individual", "Inscrición individual", "Banakako izen-ematea");
  add("Una sola vez · Toda la familia", "Una sola vegada · Tota la família", "Unha soa vez · Toda a familia", "Behin bakarrik · Familia osoa");
  add("Inscribe conjuntamente a hijos, hijas, madres y padres de las escuelas de Alaior y Maó.", "Inscriu conjuntament fills, filles, mares i pares de les escoles d'Alaior i Maó.", "Inscribe conxuntamente fillos, fillas, nais e pais das escolas de Alaior e Maó.", "Eman izena batera Alaior eta Maóko eskoletako seme-alabei eta gurasoei.");
  add("Entrenáis a la vez", "Entrenau alhora", "Adestrades á vez", "Aldi berean entrenatzen duzue");
  add("Mientras está la escuela, madres y padres también entrenan.", "Mentre hi ha escola, mares i pares també entrenen.", "Mentres está a escola, nais e pais tamén adestran.", "Eskola martxan dagoen bitartean, gurasoek ere entrenatzen dute.");
  add("Lunes a jueves · 17:30–18:30", "Dilluns a dijous · 17:30–18:30", "Luns a xoves · 17:30–18:30", "Astelehenetik ostegunera · 17:30–18:30");
  add("1 día: suplemento de 10 €/mes · 2 días: suplemento de 15 €/mes.", "1 dia: suplement de 10 €/mes · 2 dies: suplement de 15 €/mes.", "1 día: suplemento de 10 €/mes · 2 días: suplemento de 15 €/mes.", "Egun 1: 10 €/hileko gehigarria · 2 egun: 15 €/hileko gehigarria.");
  add("Ten a mano los documentos.", "Tingues a mà els documents.", "Ten a man os documentos.", "Izan dokumentuak eskura.");
  add("Necesitarás el documento de cada participante y, para los menores, el documento del tutor legal. Puedes adjuntar fotos o archivos PDF.", "Necessitaràs el document de cada participant i, per als menors, el document del tutor legal. Pots adjuntar fotos o arxius PDF.", "Necesitarás o documento de cada participante e, para os menores, o documento do titor legal. Podes achegar fotos ou ficheiros PDF.", "Parte-hartzaile bakoitzaren agiria beharko duzu eta, adingabeentzat, legezko tutorearen agiria. Argazkiak edo PDF fitxategiak erants ditzakezu.");
  add("¿Solo se inscribe una persona?", "Només s'inscriu una persona?", "Só se inscribe unha persoa?", "Pertsona bakarrak emango du izena?");
  add("Utiliza el formulario individual: será más corto para tu caso.", "Utilitza el formulari individual: serà més curt per al teu cas.", "Utiliza o formulario individual: será máis curto para o teu caso.", "Erabili banakako formularioa: laburragoa izango da zure kasurako.");
  add("Ir a inscripción individual →", "Anar a inscripció individual →", "Ir á inscrición individual →", "Joan banakako izen-ematera →");
  add("Activa JavaScript para completar la inscripción familiar.", "Activa JavaScript per completar la inscripció familiar.", "Activa JavaScript para completar a inscrición familiar.", "Aktibatu JavaScript familia-izen-ematea osatzeko.");
  add("¿Se inscribe más de una persona?", "S'inscriu més d'una persona?", "Inscríbese máis dunha persoa?", "Pertsona batek baino gehiagok emango du izena?");
  add("Hijos, hijas, madres y padres de las escuelas de Alaior y Maó pueden compartir los datos comunes.", "Fills, filles, mares i pares de les escoles d'Alaior i Maó poden compartir les dades comunes.", "Fillos, fillas, nais e pais das escolas de Alaior e Maó poden compartir os datos comúns.", "Alaior eta Maóko eskoletako seme-alabek eta gurasoek datu komunak parteka ditzakete.");
  add("Ir a inscripción familiar →", "Anar a inscripció familiar →", "Ir á inscrición familiar →", "Joan familia-izen-ematera →");
  add("Activa JavaScript para completar el formulario de inscripción.", "Activa JavaScript per completar el formulari d'inscripció.", "Activa JavaScript para completar o formulario de inscrición.", "Aktibatu JavaScript izen-emate formularioa osatzeko.");
  add("Inscribir a mi familia", "Inscriure la meva família", "Inscribir a miña familia", "Nire familiari izena eman");
  add("martes y jueves · 17:15–18:15. Mientras entrena la escuela, con suplemento familiar de 10 € por 1 día o 15 € por 2 días al mes.", "dimarts i dijous · 17:15–18:15. Mentre entrena l'escola, amb suplement familiar de 10 € per 1 dia o 15 € per 2 dies al mes.", "martes e xoves · 17:15–18:15. Mentres adestra a escola, cun suplemento familiar de 10 € por 1 día ou 15 € por 2 días ao mes.", "astearte eta osteguna · 17:15–18:15. Eskolak entrenatzen duen bitartean, familiako gehigarria 10 € da egun 1engatik edo 15 € 2 egunengatik hilean.");
  add("lunes, martes, miércoles y jueves · 17:30–18:30. Mientras entrena la escuela, con suplemento familiar de 10 € por 1 día o 15 € por 2 días al mes.", "dilluns, dimarts, dimecres i dijous · 17:30–18:30. Mentre entrena l'escola, amb suplement familiar de 10 € per 1 dia o 15 € per 2 dies al mes.", "luns, martes, mércores e xoves · 17:30–18:30. Mentres adestra a escola, cun suplemento familiar de 10 € por 1 día ou 15 € por 2 días ao mes.", "astelehen, astearte, asteazken eta osteguna · 17:30–18:30. Eskolak entrenatzen duen bitartean, familiako gehigarria 10 € da egun 1engatik edo 15 € 2 egunengatik hilean.");
  add("Abrir la inscripción familiar", "Obrir la inscripció familiar", "Abrir a inscrición familiar", "Ireki familia-izen-ematea");
  add("Escuelas de Alaior y Maó", "Escoles d'Alaior i Maó", "Escolas de Alaior e Maó", "Alaior eta Maóko eskolak");
  add("Hijos, hijas, madres y padres en un único formulario, con entrenamiento simultáneo.", "Fills, filles, mares i pares en un únic formulari, amb entrenament simultani.", "Fillos, fillas, nais e pais nun único formulario, con adestramento simultáneo.", "Seme-alabak eta gurasoak formulario bakarrean, aldi bereko entrenamenduarekin.");
  add("Adultos/as que también entrenan", "Adults que també entrenen", "Adultos/as que tamén adestran", "Entrenatuko duten helduak ere");
  add("Escuela y madres/padres · 17:15–18:15", "Escola i mares/pares · 17:15–18:15", "Escola e nais/pais · 17:15–18:15", "Eskola eta gurasoak · 17:15–18:15");
  add("Escuela y madres/padres · 17:30–18:30", "Escola i mares/pares · 17:30–18:30", "Escola e nais/pais · 17:30–18:30", "Eskola eta gurasoak · 17:30–18:30");
  add("Hijos/as que se inscriben", "Fills/es que s'inscriuen", "Fillos/as que se inscriben", "Izena emango duten seme-alabak");
  add("Empezar inscripción familiar", "Començar la inscripció familiar", "Comezar a inscrición familiar", "Hasi familia-izen-ematea");
  add("Grupo del hijo/a {number}", "Grup del fill/a {number}", "Grupo do fillo/a {number}", "{number}. seme-alabaren taldea");
  add("Grupo del adulto/a {number}", "Grup de l'adult {number}", "Grupo do adulto/a {number}", "{number}. helduaren taldea");
  add("Datos del hijo/a {number}", "Dades del fill/a {number}", "Datos do fillo/a {number}", "{number}. seme-alabaren datuak");
  add("Datos del adulto/a {number}", "Dades de l'adult {number}", "Datos do adulto/a {number}", "{number}. helduaren datuak");
  add("Hijo/a {number}", "Fill/a {number}", "Fillo/a {number}", "{number}. seme-alaba");
  add("Adulto/a {number}", "Adult {number}", "Adulto/a {number}", "{number}. heldua");
  add("{total} participante · {location}", "{total} participant · {location}", "{total} participante · {location}", "Parte-hartzaile {total} · {location}");
  add("{total} participantes · {location}", "{total} participants · {location}", "{total} participantes · {location}", "{total} parte-hartzaile · {location}");
  add("Hijos/as: {children} · Adultos/as: {parents}. Los datos comunes se rellenan una sola vez.", "Fills/es: {children} · Adults: {parents}. Les dades comunes s'emplenen una sola vegada.", "Fillos/as: {children} · Adultos/as: {parents}. Os datos comúns énchense unha soa vez.", "Seme-alabak: {children} · Helduak: {parents}. Datu komunak behin bakarrik betetzen dira.");
  add("Enviar {total} inscripción", "Enviar {total} inscripció", "Enviar {total} inscrición", "Bidali izen-emate {total}");
  add("Enviar {total} inscripciones", "Enviar {total} inscripcions", "Enviar {total} inscricións", "Bidali {total} izen-emate");
  add("Guardando {position} de {total}: {role} {number}...", "Desant {position} de {total}: {role} {number}...", "Gardando {position} de {total}: {role} {number}...", "{position}/{total} gordetzen: {role} {number}...");
  add("hijo/a", "fill/a", "fillo/a", "seme-alaba");
  add("adulto/a", "adult", "adulto/a", "heldua");
  add("Hemos guardado {total} filas vinculadas con la referencia {reference}. El club las verá agrupadas como una única familia.", "Hem desat {total} files vinculades amb la referència {reference}. El club les veurà agrupades com una única família.", "Gardamos {total} filas vinculadas coa referencia {reference}. O club veraas agrupadas como unha única familia.", "{reference} erreferentziarekin lotutako {total} errenkada gorde ditugu. Klubak familia bakar gisa taldekatuta ikusiko ditu.");
  add("{completed} de {total} personas ya están guardadas y no se duplicarán. {message}", "{completed} de {total} persones ja estan desades i no es duplicaran. {message}", "{completed} de {total} persoas xa están gardadas e non se duplicarán. {message}", "{total} pertsonatik {completed} gordeta daude eta ez dira bikoiztuko. {message}");
